...
class FinancialSetup extends DefaultModuleSetup
{
        ...
        FROM_UNIXTIME(fr.event_date, "%d-%m-%Y") as Date_événement, fr.amount_paid as `Montant versé`, fb.annual_amount as `Budget prévu`, fb.annual_amount-fb.real_amount as `Budget dépensé`,
        fb.real_amount as `Budget restant`, fr.estimate_url as `lien devis`, fr.invoice_url as `lien facture`
