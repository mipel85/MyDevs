	...
	<section id="module-user-contribution-list">
		...
		<div class="sub-section">
			<div class="content-container cell-flex cell-columns-2">
				<article class="cell-1-4 user-contribution-item several-items">
					<header>
										...
										<div class="cell-body">
											<div class="cell-content">
												<a class="offload" href="{module.U_MODULE_LINK}">
													...
													# ELSE #
														# IF module.C_FA_ICON #
															<i class="{module.FA_ICON} fa-fw"></i>
														# ELSE #
															# IF module.C_HEXA_ICON #
																<span>{module.HEXA_ICON}</span>
															# ENDIF #
														# ENDIF #
													# ENDIF #
				...
				<article class="cell-3-4 contribution-item several-items">
					<header>
