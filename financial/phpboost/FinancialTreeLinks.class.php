...
class FinancialTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
        ...
        $tree->add_link(new ModuleLink($lang['financial.archived.items'], FinancialUrlBuilder::display_monitoring_items(), FinancialAuthorizationsService::check_authorizations()->write()));
