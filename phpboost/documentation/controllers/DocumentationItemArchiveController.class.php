...
class DocumentationItemArchiveController extends DefaultModuleController
{
	...
	private function generate_response()
	{
		...
		$graphical_environment->set_page_title($item->get_title(), ($category->get_id() != Category::ROOT_CATEGORY ? $category->get_name() . ' - ' : '') . $this->lang['documentation.module.title']);
		...
		$breadcrumb->add($this->lang['documentation.archive'] . ' / ' . $item->get_item_content()->get_content_id(), DocumentationUrlBuilder::archive($category->get_id(), $category->get_rewrited_name(), $item->get_id(), $item->get_rewrited_title(), $item->get_item_content()->get_content_id()));
