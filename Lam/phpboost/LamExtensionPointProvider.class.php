...
class LamExtensionPointProvider extends ExtensionPointProvider
{
    ...
    public function css_files()
    {
        ...
        $module_css_files->adding_running_module_displayed_file('/Lam/templates/DataTables/css/buttons.dataTables.css');
        $module_css_files->adding_running_module_displayed_file('/Lam/templates/DataTables/css/jquery.dataTables.css');
