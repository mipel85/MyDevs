...
class LamFormFieldClubsEditor extends AbstractFormField
{
	...
	function display()
	{
		...
		$view = new FileTemplate('Lam/fields/LamFormFieldClubsEditor.tpl');
		$view->add_lang(LangLoader::get_all_langs('Lam'));
		...
		$row = 1;
		if (($handle = fopen(PATH_TO_ROOT . "/Lam/club/clubs_LAMPDL.csv", "r")) !== FALSE) {
