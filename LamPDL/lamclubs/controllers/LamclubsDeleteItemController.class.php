...
class LamclubsDeleteItemController extends ModuleController
{
    ...
    public function execute(HTTPRequestCustom $request)
    {
        ...
        if (!LamclubsAuthorizationsService::check_authorizations()->write() && LamclubsAuthorizationsService::check_authorizations()->contribution()) ContributionService::generate_cache();
