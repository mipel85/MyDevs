...
class FinancialRequestsMonitoringListController extends DefaultModuleController
{
    ...
    private function build_table($request)
    {
        $columns = array(
            ...
            new HTMLTableColumn('Montant estimé', 'estimate_amount'),
...
//        $table->set_css_class('modal-container');
        ...
        foreach ($result as $row)
        {
            ...
            $values = array(
                ...
                new HTMLTableRowCell($item->get_estimate_amount() <> '' ? $item->get_estimate_amount() . '€ ' : '---'),
                ...
                new HTMLTableRowCell(
                    ...
                    <div id="target-panel-' . $row['id'] . '"class="modal">
                        <div class="modal-overlay close-modal" aria-label="' . $this->lang['common.close'] . '"></div>
