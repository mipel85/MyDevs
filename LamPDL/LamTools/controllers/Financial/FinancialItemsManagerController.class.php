...
class FinancialItemsManagerController extends DefaultModuleController
{
    ...
    {
        return new FileTemplate('LamTools/FinancialItemsManagerController.tpl');
    }
    ...
    private function build_activity_table()
    {
        ...
        $table_model = new SQLHTMLTableModel(LamToolsSetup::$lam_forms, 'items-manager', $columns, new HTMLTableSortingRule('activity_type', HTMLTableSortingRule::DESC));
    ...
    private function generate_response($page = 1)
    {
        ...
        $graphical_environment->get_seo_meta_data()->set_canonical_url(ToolsUrlBuilder::activity());

        $breadcrumb = $graphical_environment->get_breadcrumb();
        $breadcrumb->add($this->lang['lam.jpo'], ToolsUrlBuilder::home());
        $breadcrumb->add($this->lang['lam.jpo'], ToolsUrlBuilder::activity());
