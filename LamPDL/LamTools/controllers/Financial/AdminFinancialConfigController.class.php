...
// configuration fieldset
        ...
        $fieldset->add_field(new FormFieldMailEditor('recipient_mail_1', $this->lang['lamfinancial.recipient.mail_1'], $this->config->get_recipient_mail_1(), array(
            'description' => StringVars::replace_vars($this->lang['lamfinancial.email.configuration.default'], array('default_mail' => LamToolsConfig::load()->get_recipient_mail_1())),
            'required'    => true,
...
// Authorizations
		...
		$auth_settings = new AuthorizationsSettings(array(
            new ActionAuthorization($this->lang['lamfinancial.authorization.requests'], FinancialAuthorizationsService::REQUESTS_AUTHORIZATIONS),
            new MemberDisabledActionAuthorization($this->lang['lamfinancial.authorization.treasurer'], FinancialAuthorizationsService::MANAGE_AUTHORIZATIONS)
        ));
