<section id="module-financial">
    ...
    <div class="sub-section">
        <div class="content-container">
            ...
            <div class="flex-between">
                <span class="open-span-button">{@financial.dedicated.desc}</span>
                <a href="${relative_url(FinancialUrlBuilder::dedicated())}" class="offload button bgc visitor open-button"><span>{@financial.form.open}</span></a>
            </div>
            # ELSE #
