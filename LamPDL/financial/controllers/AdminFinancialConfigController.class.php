...
class AdminFinancialConfigController extends DefaultAdminModuleController
{
    ...
    private function build_form()
    {
        ...
        $fieldset->add_field(new FormFieldMailEditor(
            'recipient_mail_1',
            $this->lang['financial.recipient.mail_1'],
            $this->config->get_recipient_mail_1(),
            array(
        ...
        $fieldset->add_field(new FormFieldMailEditor(
            'recipient_mail_2',
            $this->lang['financial.recipient.mail_2'],
            $this->config->get_recipient_mail_2(),
            array(
        ...
        $fieldset->add_field(new FormFieldMailEditor(
            'recipient_mail_3',
            $this->lang['financial.recipient.mail_3'],
            $this->config->get_recipient_mail_3(),
            array(
            'description' => $this->lang['financial.email.configuration.optional'],
            'class'       => 'top-field third-field'
            )
        ...
        $fieldset->add_field(new FormFieldCheckbox(
            'winter_break',
            $this->lang['financial.winter.break'],
            $this->config->get_winter_break(),
    ...
    private function build_reset_form()
    {
        ...
        $fieldset->add_field(new FormFieldTextEditor(
            'reset_date',
            $this->lang['financial.reset.date'],
            '',
            array(
                'required'    => true,
