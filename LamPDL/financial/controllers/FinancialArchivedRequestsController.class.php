 ...
 */
class FinancialArchivedRequestsController extends DefaultModuleController
{

    protected function get_template_to_use()
    {
        return new FileTemplate('financial/FinancialArchivedRequestsController.tpl');
    }
    ...
    private function generate_response($page = 1)
    {
        ...
        $graphical_environment->set_page_title($this->lang['financial.archived.requests'], $this->lang['financial.archived.requests'], $page);
        $graphical_environment->get_seo_meta_data()->set_canonical_url(FinancialUrlBuilder::archived_requests());

        $breadcrumb = $graphical_environment->get_breadcrumb();
        $breadcrumb->add($this->lang['financial.home'], FinancialUrlBuilder::home());
        $breadcrumb->add($this->lang['financial.archived.requests'], FinancialUrlBuilder::archived_requests());
