...
class FinancialBudgetFormController extends DefaultModuleController
{
    ...
    private function redirect()
    {
        ...
        }else AppContext::get_response()->redirect(($this->form->get_value('referrer') ? $this->form->get_value('referrer') : FinancialUrlBuilder::home()), StringVars::replace_vars($this->lang['financial.message.success.edit'], array('budget_type' => $budget->get_budget_type())));
    }
