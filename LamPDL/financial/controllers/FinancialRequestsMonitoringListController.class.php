...
class FinancialRequestsMonitoringListController extends DefaultModuleController
{
    ...
    private function generate_response($page = 1)
    {
        ...
        $graphical_environment->get_seo_meta_data()->set_canonical_url(FinancialUrlBuilder::requests_monitoring_list());

        $breadcrumb = $graphical_environment->get_breadcrumb();
        $breadcrumb->add($this->lang['financial.module.title'], FinancialUrlBuilder::home());
        $breadcrumb->add($this->lang['financial.budgets.statement'], FinancialUrlBuilder::requests_monitoring_list());
