...
class FinancialRequestsChartController extends DefaultModuleController
{
	...
	{
		return new FileTemplate('financial/FinancialRequestsChartController.tpl');
	}
	...
	private function generate_response(HTTPRequestCustom $request)
	{
		...
		$graphical_environment->get_seo_meta_data()->set_canonical_url(FinancialUrlBuilder::requests_chart());
		//
		$breadcrumb = $graphical_environment->get_breadcrumb();
		$breadcrumb->add($this->lang['financial.module.title'], FinancialUrlBuilder::home());
		$breadcrumb->add($page_title, FinancialUrlBuilder::requests_chart());
