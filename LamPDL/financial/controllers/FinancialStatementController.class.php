...
class FinancialStatementController extends DefaultModuleController
{
    ...
    private function generate_response($page = 1)
    {
        ...
        $graphical_environment->get_seo_meta_data()->set_canonical_url(FinancialUrlBuilder::financial_statement());

        $breadcrumb = $graphical_environment->get_breadcrumb();
        $breadcrumb->add($this->lang['financial.home'], FinancialUrlBuilder::home());
        $breadcrumb->add($this->lang['financial.financial.statement'], FinancialUrlBuilder::financial_statement());
