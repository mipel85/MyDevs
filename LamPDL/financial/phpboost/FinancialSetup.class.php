...
class FinancialSetup extends DefaultModuleSetup
{
    ...
    public static function create_financial_statement_view()
    {
        ...
        SELECT fr.id, fb.domain AS Domaine, fr.title as `Type de demande`, lc.ffam_nb as `N° FFAM`, lc.name as Club, mem.display_name as Demandeur, fr.request_description,
