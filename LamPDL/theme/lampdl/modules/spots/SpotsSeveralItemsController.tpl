<section id="module-spots" class="several-items">
    ...
    # ENDIF #
        ...
        <div # IF C_CATEGORY ## IF C_SELF_ITEMS # class="cell-flex cell-columns-2"# ENDIF ## ENDIF #>
            # IF C_CATEGORY #
                <div # IF C_SELF_ITEMS # class="sub-section cell-2-3"# ENDIF #>
                    <div class="content-container">
                        # IF C_GMAP_ENABLED #
            ...
            # ENDIF #
            <div # IF C_CATEGORY # class="cell-1-3"# ENDIF #>
