...
<div id="tdb">
    <table id="tdb-table">
        ...
        <tbody class="tdb-tbody">
            ...
            # START tdb_request #
            <tr>
                <td>44 - Loire Atlantique</td><td id="tdb_ffam_44" aria-label="Liste des clubs de Loire-Atlantique" class="counter-number">{tdb_ffam.FFAM_44}</td><td id="tdb_site_44">{tdb_site.SITE_44}</td><td>{tdb_planning.PLANNING_44}</td><td id="tdb_request_49">{tdb_request.REQUEST_44}</td>
            </tr>
            <tr>
                <td>49 - Maine et Loire</td><td id="tdb_ffam_49">{tdb_ffam.FFAM_49}</td><td id="tdb_site_49">{tdb_site.SITE_49}</td><td>{tdb_planning.PLANNING_49}</td><td id="tdb_request_49">{tdb_request.REQUEST_49}</td>
            </tr>
            <tr>
                <td>53 - Mayenne</td><td id="tdb_ffam_53">{tdb_ffam.FFAM_53}</td><td id="tdb_site_53">{tdb_site.SITE_53}</td><td>{tdb_planning.PLANNING_53}</td><td id="tdb_request_53">{tdb_request.REQUEST_53}</td>
            </tr>
            <tr>
                <td>72 - Sarthe</td><td id="tdb_ffam_72">{tdb_ffam.FFAM_72}</td><td id="tdb_site_72">{tdb_site.SITE_72}</td><td>{tdb_planning.PLANNING_72}</td><td id="tdb_request_72">{tdb_request.REQUEST_72}</td>
            </tr>
            <tr>
                <td>85 - Vendée</td><td id="tdb_ffam_85">{tdb_ffam.FFAM_85}</td><td id="tdb_site_85">{tdb_site.SITE_85}</td><td>{tdb_planning.PLANNING_85}</td><td id="tdb_request_85">{tdb_request.REQUEST_85}</td>
            </tr>
            <tr>
                <td>Total</td><td id="tdb_ffam_00">{tdb_ffam.FFAM_TOTAL}<span aria-label="Détails" alt="voir"></span></td><td id="tdb_site_00">{tdb_site.SITE_TOTAL}</td><td>{tdb_planning.PLANNING_TOTAL}</td><td id="tdb_request_00">{tdb_request.REQUEST_TOTAL}</td>
            </tr>
            # END tdb_site #
            # END tdb_ffam #
            # END tdb_request #
