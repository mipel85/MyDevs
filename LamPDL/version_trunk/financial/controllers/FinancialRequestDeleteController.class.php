...
class FinancialRequestDeleteController extends DefaultModuleController
{
    public function execute(HTTPRequestCustom $request)
    {
        ...
        if ($item->get_agreement_state() == FinancialRequestItem::PENDING || $item->get_agreement_state() == FinancialRequestItem::ONGOING) FinancialMonitoringService::delete_pending_request($item->get_id());
