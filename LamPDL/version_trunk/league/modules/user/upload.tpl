<script>
	...
	function display_new_folder()
	{
		...
		if( !hide_folder )
		{
			document.getElementById('new-folder').innerHTML += '<div id="new-folder-' + divid + '" class="cell"><div class="cell-header"><div class="cell-name ellipsis"><input type="text" name="folder_name" id="folder_name" value="" onblur="add_folder(\'{FOLDER_ID}\', \'{USER_ID}\', ' + divid + ');"></div><i class="fa fa-folder"></i></div></div>';
			document.getElementById('folder_name').focus();
		}
		else
		{
			document.getElementById('new-folder-' + (divid - 1)).style.display = 'block';
			document.getElementById('new-folder-' + (divid - 1)).innerHTML = '<div id="new-folder-' + divid + '" class="cell"><div class="cell-header"><div class="cell-name ellipsis"><input type="text" name="folder_name" id="folder_name" value="" onblur="add_folder(\'{FOLDER_ID}\', \'{USER_ID}\', ' + (divid - 1) + ');"></div><i class="fa fa-folder"></i></div></div>';
			document.getElementById('folder_name').focus();
			this.divid--;
			hide_folder = false;
		}
                                                        ...
                                                        <div class="cell# IF personal_files.C_RECENT_FILE # new-content# ENDIF ## IF NOT personal_files.C_FILE_EXISTS # missing-file# ENDIF #">
                                                            ...
                                                            <div class="cell-list">
                                                                <ul class="small">
                                                                    ...
                                                                    <li class="li-stretch" aria-label="{@upload.file.date}"><span><i class="far fa-clock" aria-hidden="true"></i></span> <span>{personal_files.DATE_FULL}</span></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    # END personal_files #
                                                        ...
                                                        <div class="cell# IF shared_files.C_RECENT_FILE # new-content# ENDIF ## IF NOT shared_files.C_FILE_EXISTS # missing-file# ENDIF #">
                                                            ...
                                                            <div class="cell-list">
                                                                <ul class="small">
                                                                    ...
                                                                    <li class="li-stretch" aria-label="{@upload.file.date}"><span><i class="far fa-clock" aria-hidden="true"></i></span><span>{shared_files.DATE_FULL}</span></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    # END shared_files #
