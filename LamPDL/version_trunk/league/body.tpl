...
<header id="header">
	<div id="top-header">
        ...
        # IF C_VISIT_COUNTER #
            <div id="visit-counter" class="hidden-small-screens">
                <div id="visit-counter-total" class="visit-count">
                    <span class="">{@user.guests} &nbsp;</span>
                    <span class="">{VISIT_COUNTER_TOTAL}</span>
                </div>
                <div id="visit-counter-today" class="visit-count">
                    <span class="">{@date.today}</span>
                    <span class="">{VISIT_COUNTER_DAY}</span>
                </div>
            </div>
        # ENDIF #
	</div>
	<div id="inner-header">
		<div id="inner-header-container" class="content-wrapper">
			<div id="site-infos" role="banner">
				<div id="site-logo-left" class="site-logo" # IF C_HEADER_LOGO #style="background-image: url({U_HEADER_LOGO});"# ENDIF #></div>
				<div id="site-name-container">
					<a class="offload" id="site-name" href="{PATH_TO_ROOT}/">{SITE_NAME}</a>
					<span id="site-slogan">{SITE_SLOGAN}</span>
				</div>
                <div id="site-logo-right" class="site-logo"></div>
			</div>
	...
	<div id="sub-header" class="left-color">
