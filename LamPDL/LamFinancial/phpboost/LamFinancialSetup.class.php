 ...
 */
class LamFinancialSetup extends DefaultModuleSetup
{
    public static $lamfinancial;

    public static function __static()
    {
        self::$lamfinancial = PREFIX . 'lamfinancial';
    }
    ...
    {
        $this->drop_tables();
        ConfigManager::delete('LamFinancial', 'config');
    }

    private function drop_tables()
    {
        PersistenceContext::get_dbms_utils()->drop(array(self::$lamfinancial));
    }

    private function create_tables()
    {
        $this->create_lamfinancial_table();
    }

    private function create_lamfinancial_table()
    {
        $fields = array(
        ...
        PersistenceContext::get_dbms_utils()->create_table(self::$lamfinancial, $fields, $options);
    }
}
?>
