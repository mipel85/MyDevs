 ...
 */
class LamFinancialConfig extends AbstractConfigData
{
...
// financial  
    ...
    {
        return ConfigManager::load(__CLASS__, 'lamfinancial', 'config');
    }

    /**
     * @method Saves Lamfinancial configuration in the database. It becomes persistent.
     */
    public static function save()
    {
        ConfigManager::save('lamfinancial', self::load(), 'config');
    }
}
?>
