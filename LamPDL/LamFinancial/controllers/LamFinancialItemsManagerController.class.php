...
class LamFinancialItemsManagerController extends DefaultModuleController
{
    ...
    private function build_activity_table()
    {
        ...
        $table_model = new SQLHTMLTableModel(LamFinancialSetup::$lamfinancial, 'items-manager', $columns, new HTMLTableSortingRule('activity_type', HTMLTableSortingRule::DESC));
        ...
        {
            $item = new LamFinancialActivityItem();
    ...
    private function generate_response($page = 1)
    {
        ...
        $graphical_environment->get_seo_meta_data()->set_canonical_url(LamFinancialUrlBuilder::activity());

        $breadcrumb = $graphical_environment->get_breadcrumb();
        $breadcrumb->add($this->lang['lam.jpo'], LamFinancialUrlBuilder::home());
        $breadcrumb->add($this->lang['lam.jpo'], LamFinancialUrlBuilder::activity());
