 ...
 * @version     PHPBoost 6.0 - last update: 2023 05 02
...
class LamFinancialFormActivityController extends DefaultModuleController
{
    ...
    private function build_form()
    {
        ...
        // other fields
        $fieldset->add_field(new LamFinancialFormFieldClubsEditor('club_infos', $this->lang['lamfinancial.club.infos'], array(), array('description' => $this->lang['lamfinancial.club.infos.clue'])));
    ...
    private function get_item()
    {
        if ($this->item === null){
            ...
            if (!empty($id)){
                ...
                $this->item = new LamFinancialItem();
            }
        }
        return $this->item;
    }
    ...
    private function save()
    {
        ...
        $id = LamFinancialService::add($item);
        $item->set_id($id);
    }
    ...
    private function build_response(View $view)
    {
        ...
        $breadcrumb->add($this->lang['lamfinancial.form'], LamFinancialUrlBuilder::activity());
    ...
    private function send_form_email()
    {
        ...
        $item_email->add_recipient(!empty(LamFinancialConfig::load()->get_recipient_mail_2()) ? LamConfig::load()->get_recipient_mail_2() : '');
        $item_email->add_recipient(!empty(LamFinancialConfig::load()->get_recipient_mail_3()) ? LamConfig::load()->get_recipient_mail_3() : '');
