...
$lang['review.first.analyse']                           = '<div class="message-helper bgc warning"><ul><li>No files have been found in website content</li><li>The module just have been installed.</li></ul>Analyse content by pressing the button above.</div>';
$lang['review.cache']                                   = 'Scan files';
$lang['review.refresh']                                 = 'Rescan files';
$lang['review.new.files']                               = 'News files are in';
$lang['review.no.files.added']                          = 'No new files';
...
$lang['review.counters.title.files.on.server']          = 'Files present in /upload folder';
$lang['review.counters.title.files.in.upload']          = 'Files present in the upload table';
$lang['review.counters.title.files.in.gallery.folder']  = 'Files present in /gallery/pics folder';
...
$lang['review.counters.orphans.files']                   = 'Orphan files (unused and without bdd link)';
...
// Pages
$lang['review.home']            = ' - Home';
$lang['review.inuploadfolder']        = ' on server';
$lang['review.ingalleryfolder'] = ' in the Gallery folder';
$lang['review.ingallerytable']  = ' in the Gallery table';
$lang['review.galleryusedbutmissing'] = ' in the Gallery table but missing from Gallery folder';
$lang['review.galleryunusedbutintable']  = ' in the Gallery folder but missing from Gallery table';
$lang['review.inuploadtable']        = ' in the upload folder';
$lang['review.incontenttable']       = ' in content';
$lang['review.allunused']       = ' not used';
$lang['review.usedbutmissing']    = ' used but missing from server';
$lang['review.unusedbutintable']      = ' not used but setted in upload table';
$lang['review.orphans']          = ' orphanss';
