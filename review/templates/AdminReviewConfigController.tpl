...
<script>
    ...
    jQuery('#onblurContainerResponseAdminReviewConfigController_folders_list .form-field-checkbox').each(function(){
        ...
        let fileClass = '';
        if (hasFiles == 'has_files')
            fileClass = 'has-files';

        // set data's depending on folder tree
        if(cbSpanSplit.length == 10) // eighth row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6+'-'+lv7+'-'+lv8, class: fileClass, 'data-cb-id': lv8, 'data-cb-parent' : lv7, 'data-cb-order': lv8}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6+'-'+lv7);
        }
        else if(cbSpanSplit.length == 9) // seventh row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6+'-'+lv7, class: fileClass, 'data-cb-id': lv7, 'data-cb-parent' : lv6, 'data-cb-order': lv7}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6+'-'+lv7, class : 'level-7'}).appendTo(['#li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6+'-'+lv7]);
        }
        else if(cbSpanSplit.length == 8) // sixth row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6, class: fileClass, 'data-cb-id': lv6, 'data-cb-parent' : lv5, 'data-cb-order': lv6}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6, class : 'level-6'}).appendTo(['#li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5+'-'+lv6]);
        }
        else if(cbSpanSplit.length == 7) // fifth row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5, class: fileClass, 'data-cb-id': lv5, 'data-cb-parent' : lv4, 'data-cb-order': lv5}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5, class : 'level-5'}).appendTo(['#li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4+'-'+lv5]);
        }
        else if(cbSpanSplit.length == 6) // forth row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4, class: fileClass, 'data-cb-id': lv4, 'data-cb-parent' : lv3, 'data-cb-order': lv4}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2+'-'+lv3);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4, class : 'level-4'}).appendTo(['#li-'+lv1+'-'+lv2+'-'+lv3+'-'+lv4]);
        }
        else if(cbSpanSplit.length == 5) // third row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2+'-'+lv3, class: fileClass, 'data-cb-id': lv3, 'data-cb-parent' : lv2, 'data-cb-order': lv3}).html(cbLabel).appendTo('#ul-'+lv1+'-'+lv2);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2+'-'+lv3, class : 'level-3'}).appendTo(['#li-'+lv1+'-'+lv2+'-'+lv3]);
        }
        else if(cbSpanSplit.length == 4) // second row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1+'-'+lv2, class: fileClass, 'data-cb-id': lv2, 'data-cb-parent' : lv1, 'data-cb-order': lv2}).html(cbLabel).appendTo('#ul-'+lv1);
            jQuery('<ul/>', {id: 'ul-'+lv1+'-'+lv2, class : 'level-2'}).appendTo(['#li-'+lv1+'-'+lv2]);
        }
        else if(cbSpanSplit.length == 3) // first row in root folders
        {
            jQuery('<li/>', {id: 'li-'+lv1, class: 'first-row ' + fileClass, 'data-cb-id': lv1, 'data-cb-parent' : 0, 'data-cb-order': lv1}).html(cbLabel).appendTo('#cb-list');
